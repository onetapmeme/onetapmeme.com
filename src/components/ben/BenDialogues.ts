...
export const benDialogues: BenDialogues = {
  ...
  fr: {
    ...
    hero: { text: "Bienvenue, 1Tapper. Laissez-moi vous montrer ce que nous construisons. 🎯", duration: 7000 },
    ...
    community: { text: "Rejoignez l'équipe. Devenez Un OneTapper. 🎮", duration: 7000 },
    ...
    footer: { text: "Tous les documents légaux et contacts sont ici. ⚖️", duration: 7000 },
  },
  es: {
    spawn: { text: "Objetivo bloqueado. Bienvenido a $ONETAP.", duration: 3000 },
    hero: { text: "Bienvenido, 1Tapper. Déjame mostrarte lo que estamos construyendo. 🎯", duration: 7000 },
    ...
    footer: { text: "Todos los documentos legales e información de contacto están aquí. ⚖️", duration: 7000 },
  },
  ru: {
    spawn: { text: "Цель заблокирована. Добро пожаловать в $ONETAP.", duration: 3000 },
    hero: { text: "Добро пожаловать, 1Tapper. Позвольте показать, что мы создаем. 🎯", duration: 7000 },
    ...
    community: { text: "Присоединяйтесь к команде. Станьте OneTapper'ом. 🎮", duration: 7000 },
    ...
    footer: { text: "Вся юридическая информация и контакты здесь. ⚖️", duration: 7000 },
  },
  zh: {
    spawn: { text: "目标锁定。欢迎来到 $ONETAP。", duration: 3000 },
    hero: { text: "欢迎，1Tapper。让我展示我们正在构建的内容。🎯", duration: 7000 },
    ...
    community: { text: "加入小队。成为一名 OneTapper。🎮", duration: 7000 },
