...
const sectionPositions: Record<string, BenPosition> = {
  ...
  'why-onetap': { bottom: '20px', right: '20px', section: 'why-onetap', sprite: 'explaining' },
  swap: { bottom: '20px', right: '20px', section: 'swap', sprite: 'shooting' },
  'live-stats': { bottom: '20px', right: '20px', section: 'live-stats', sprite: 'thinking' },
  roadmap: { bottom: '20px', right: '20px', section: 'roadmap', sprite: 'pointing' },
  ...
  airdrops: { bottom: '20px', right: '20px', section: 'airdrops', sprite: 'celebrating' },
  community: { bottom: '20px', right: '20px', section: 'community', sprite: 'winking' },
  media: { bottom: '20px', right: '20px', section: 'media', sprite: 'talking' },
  videos: { bottom: '20px', right: '20px', section: 'videos', sprite: 'explaining' },
  'social-proof': { bottom: '20px', right: '20px', section: 'social-proof', sprite: 'smiling' },
