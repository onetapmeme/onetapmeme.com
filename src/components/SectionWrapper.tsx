...
interface SectionWrapperProps {
  ...
  blendFrom?: 'primary' | 'accent' | 'neutral';
  className?: string;
}

const SectionWrapper = ({ children, variant = 'primary', blendFrom, className = '' }: SectionWrapperProps) => {
  const getColors = (v: 'primary' | 'accent' | 'neutral') => {
    switch (v) {
      case 'primary':
        return {
  ...
  const prevColors = blendFrom ? getColors(blendFrom) : colors;
