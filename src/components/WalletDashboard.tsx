...
const WalletDashboard = () => {
  ...
  const mockTransactions = [
    { type: 'buy', amount: '500,000 CardSurgery', time: '2 hours ago', usd: '$250' },
    { type: 'sell', amount: '200,000 CardSurgery', time: '1 day ago', usd: '$100' },
    { type: 'claim', amount: '50,000 CardSurgery', time: '3 days ago', usd: '$25' },
  ];
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Connect your wallet to view your portfolio, track rewards, and manage your CardSurgery holdings.
            </p>
            <WalletConnect />
          </motion.div>
        </div>
